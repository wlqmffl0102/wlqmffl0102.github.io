...
어느것을 사용하여도 됩니다만, 저는 VSCode를 사용합니다. 필요시에 따라 Visual Studio를 사용하기도 하나, 포스팅에서는 VSCode를 이용하도록 하겠습니다.
...
하지만 모든 내용을 다룰수는 없다고 판단하여, 다음 포스팅은 HTML에서 많이 사용되는 태그 32선에 관해 다뤄보고자 합니다.
