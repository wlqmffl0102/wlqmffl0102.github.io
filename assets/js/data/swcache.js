...
const resource = [
  ...
  '{{ favicon_path }}/android-chrome-96x96.png',
  '{{ favicon_path }}/apple-touch-icon-57x57.png',
  '{{ favicon_path }}/apple-touch-icon-60x60.png',
  '{{ favicon_path }}/apple-touch-icon-72x72.png',
  '{{ favicon_path }}/apple-touch-icon-76x76.png',
  '{{ favicon_path }}/apple-touch-icon-114x114.png',
  '{{ favicon_path }}/apple-touch-icon-120x120.png',
